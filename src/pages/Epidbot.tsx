...
function Features() {
  ...
  const icons = [Database, Brain, TrendingUp, FileText, Users, Sparkles];
  const features = t.features.items.map(([title, desc], index) => ({ icon: icons[index], title, desc }));
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature, i) => {
            ...
            return (
              <div
                key={feature.title}
                className={`group relative p-7 rounded-2xl border border-white/[0.06] bg-white/[0.02] hover:border-kwar-electric/20 hover:bg-white/[0.03] transition-all duration-500 ${
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                <div className="w-10 h-10 rounded-xl bg-kwar-electric/10 border border-kwar-electric/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                  <Icon className="w-5 h-5 text-kwar-electric" />
                </div>
                <h3 className="text-white font-semibold text-base mb-2">{feature.title}</h3>
                <p className="text-white/40 text-sm leading-relaxed">{feature.desc}</p>

                {/* Subtle glow on hover */}
                <div className="absolute inset-0 rounded-2xl bg-kwar-electric/[0.02] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
              </div>
            );
          })}
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              {tasks.map((task) => {
                ...
                return (
                  <div key={task.label} className="flex items-center gap-3 text-sm text-white/50">
                    <Icon className="w-4 h-4 text-kwar-electric/60" />
            ...
            <div className="inline-flex items-start gap-3 p-4 rounded-xl border border-kwar-electric/20 bg-kwar-electric/[0.03]">
              <Clock className="w-5 h-5 text-kwar-electric flex-shrink-0 mt-0.5" />
              <p className="text-sm text-kwar-electric/80">
                {t.roi.note}
              </p>
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative rounded-2xl border border-white/[0.08] bg-[#0d1117]/80 backdrop-blur-sm overflow-hidden shadow-2xl shadow-kwar-electric/5">
              {/* Chat header */}
              <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.04]">
                <div className="px-2 py-1 rounded-md bg-kwar-electric/10 text-[10px] text-kwar-electric font-medium">Pergunta</div>
              </div>

              {/* Question bubble */}
              <div className="px-4 py-3">
                <div className="bg-kwar-electric/10 border border-kwar-electric/20 rounded-xl rounded-tl-sm px-4 py-3 max-w-[90%] ml-auto">
              ...
              <div className="px-4 pb-4">
                <div className="bg-[#0a0e14] rounded-xl border border-white/[0.04] overflow-hidden">
                  <div className="px-4 py-3 border-b border-white/[0.04] flex items-center justify-between">
                    ...
                    <button className="text-[10px] text-kwar-electric flex items-center gap-1">
  ...
  return (
    <section ref={ref} className="py-16 lg:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div
          className={`relative rounded-2xl border border-white/[0.06] bg-gradient-to-r from-kwar-electric/[0.05] to-kwar-gold/[0.04] p-8 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-8 transition-all duration-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-kwar-electric/10 border border-kwar-electric/20 flex items-center justify-center flex-shrink-0">
              <Shield className="w-6 h-6 text-kwar-electric" />
            </div>
            <div>
              <h3 className="font-display text-2xl font-bold text-white mb-2">{t.final.title}</h3>
          ...
          <button className="bg-kwar-electric hover:bg-kwar-electric/90 text-kwar-deep text-sm font-semibold px-8 py-3 rounded-lg transition-all duration-300 hover:shadow-glow flex-shrink-0">
            {t.final.cta}
          </button>
        </div>
      </div>
